...
- [ ] **Phase 1: 核心链路与阅读模式集成** - 引入内容提取逻辑，验证 PDF 生成稳定性。
- [ ] **Phase 2: 导出样式定制** - 字体、页边距、元数据处理。
...
**Plans**:
- [ ] 01-01-PLAN.md — 环境初始化与依赖集成 (Wave 1)
- [ ] 01-02-PLAN.md — 内容提取模块开发 (TDD) (Wave 2)
- [ ] 01-03-PLAN.md — 核心链路集成与 PDF 优化 (Wave 3)
- [ ] 01-04-PLAN.md — UI 增强与验证 (Wave 4)
**UI hint**: yes
...
| 阶段 | 计划状态 | 状态 | 完成时间 |
|-------|----------|------|----------|
| 1. 核心链路与阅读模式集成 | 0/4 | Not started | - |
| 2. 导出样式定制 | 0/0 | Not started | - |
| 3. 配置持久化与用户体验优化 | 0/0 | Not started | - |
| 4. 兼容性与性能加固 | 0/0 | Not started | - |
